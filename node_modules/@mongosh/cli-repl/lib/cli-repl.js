...
class CliRepl {
    ...
    setupAnalytics() {
        ...
        const apiKey = (_c = (_b = this.analyticsOptions) === null || _b === void 0 ? void 0 : _b.apiKey) !== null && _c !== void 0 ? _c : (0, build_info_1.buildInfo)({ withSegmentApiKey: true }).segmentApiKey;
        if (!apiKey) {
